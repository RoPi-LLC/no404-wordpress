...
return array(
	...
	// Setup wizard (1.1.0).
	'Paste your API key first.' => 'Fügen Sie zuerst Ihren API-Schlüssel ein.',
	'This key belongs to %1$s, but this WordPress site is %2$s. Copy this site\'s key from its Integration tab in the no404 dashboard. If you are sure, you can still save the key on the settings page.' => 'Dieser Schlüssel gehört zu %1$s, diese WordPress-Website ist aber %2$s. Kopieren Sie den Schlüssel dieser Website aus ihrem Tab „Integration“ im no404-Dashboard. Wenn Sie sicher sind, können Sie den Schlüssel trotzdem auf der Einstellungsseite speichern.',
	'Connected to %s.' => 'Verbunden mit %s.',
	'no404 setup' => 'no404-Einrichtung',
	'no404 is installed but not connected yet.' => 'no404 ist installiert, aber noch nicht verbunden.',
	'Run the setup wizard' => 'Einrichtungsassistenten starten',
	'Dismiss' => 'Ausblenden',
	'Welcome' => 'Willkommen',
	'Connect' => 'Verbinden',
	...
	'Welcome to no404' => 'Willkommen bei no404',
	'When a visitor lands on a page that no longer exists, no404 finds the closest live page on your site and sends them there with a real server-side 301. There are no redirect rules to write.' => 'Wenn ein Besucher auf einer Seite landet, die es nicht mehr gibt, findet no404 die ähnlichste aktive Seite Ihrer Website und leitet ihn mit einer echten serverseitigen 301 dorthin. Sie müssen keine Weiterleitungsregeln schreiben.',
	'no404 is a hosted service, so the plugin needs a free no404 account and an API key. Setup takes about two minutes.' => 'no404 ist ein gehosteter Dienst. Das Plugin benötigt daher ein kostenloses no404-Konto und einen API-Schlüssel. Die Einrichtung dauert etwa zwei Minuten.',
	'Create a free account' => 'Kostenloses Konto erstellen',
	'I already have an account' => 'Ich habe bereits ein Konto',
	'The sign-up page opens in a new tab with this site\'s address filled in. Add the site there, then come back to this tab.' => 'Die Registrierungsseite öffnet sich in einem neuen Tab, die Adresse dieser Website ist bereits eingetragen. Fügen Sie die Website dort hinzu und kehren Sie dann zu diesem Tab zurück.',
	'Connect your site' => 'Website verbinden',
	'In your no404 dashboard, open this site and go to the Integration tab. Copy the API key from the WordPress card and paste it below.' => 'Öffnen Sie diese Website in Ihrem no404-Dashboard und wechseln Sie zum Tab „Integration“. Kopieren Sie den API-Schlüssel aus der WordPress-Karte und fügen Sie ihn unten ein.',
	'Open the no404 dashboard' => 'no404-Dashboard öffnen',
	'Back' => 'Zurück',
	'How should redirects be sent?' => 'Wie sollen Weiterleitungen gesendet werden?',
	'Follow my no404 dashboard (recommended)' => 'Meinem no404-Dashboard folgen (empfohlen)',
	'Confident matches and your own redirects get a permanent 301, uncertain guesses a temporary 302. You can change the threshold later in your no404 dashboard without touching WordPress.' => 'Sichere Treffer und Ihre eigenen Weiterleitungen erhalten eine dauerhafte 301, unsichere Vermutungen eine vorübergehende 302. Den Schwellenwert können Sie später im no404-Dashboard ändern, ohne WordPress anzufassen.',
	'Only if your catalogue is complete: browsers cache a 301 permanently, so a wrong match cannot be taken back.' => 'Nur wenn Ihr Katalog vollständig ist: Browser speichern eine 301 dauerhaft, ein falscher Treffer lässt sich nicht zurücknehmen.',
	'Continue' => 'Weiter',
	'You are all set' => 'Alles bereit',
	'no404 is now redirecting pages that are not found on %s.' => 'no404 leitet jetzt nicht gefundene Seiten auf %s weiter.',
	'Try it with an old address' => 'Mit einer alten Adresse ausprobieren',
	'Enter an address that no longer exists on your site. The test counts as one lookup and shows up in your no404 dashboard.' => 'Geben Sie eine Adresse ein, die es auf Ihrer Website nicht mehr gibt. Der Test zählt als eine Abfrage und erscheint in Ihrem no404-Dashboard.',
	'Go to settings' => 'Zu den Einstellungen',
	'Monitoring for this site is paused in the no404 dashboard. Resume it there to start redirecting.' => 'Die Überwachung dieser Website ist im no404-Dashboard pausiert. Setzen Sie sie dort fort, um mit dem Weiterleiten zu beginnen.',
	'Your no404 subscription is not active, so nothing is redirected yet. Check your plan in the no404 dashboard.' => 'Ihr no404-Abonnement ist nicht aktiv, daher wird noch nichts weitergeleitet. Prüfen Sie Ihren Tarif im no404-Dashboard.',
	'Your monthly lookup quota is used up. Redirects start again when it resets, or you can upgrade your plan in the no404 dashboard.' => 'Ihr monatliches Abfragekontingent ist aufgebraucht. Die Weiterleitungen starten wieder, sobald es zurückgesetzt wird, oder Sie wechseln im no404-Dashboard in einen größeren Tarif.',
	'Your no404 account is suspended. Contact no404 support.' => 'Ihr no404-Konto ist gesperrt. Wenden Sie sich an den no404-Support.',
);
