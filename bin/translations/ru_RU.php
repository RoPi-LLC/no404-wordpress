...
return array(
	...
	// Setup wizard (1.1.0).
	'Paste your API key first.' => 'Сначала вставьте API-ключ.',
	'This key belongs to %1$s, but this WordPress site is %2$s. Copy this site\'s key from its Integration tab in the no404 dashboard. If you are sure, you can still save the key on the settings page.' => 'Этот ключ принадлежит сайту %1$s, а этот сайт WordPress — %2$s. Скопируйте ключ этого сайта на его вкладке «Интеграция» в панели no404. Если вы уверены, ключ всё равно можно сохранить на странице настроек.',
	'Connected to %s.' => 'Подключено к %s.',
	'no404 setup' => 'Настройка no404',
	'no404 is installed but not connected yet.' => 'no404 установлен, но ещё не подключён.',
	'Run the setup wizard' => 'Запустить мастер настройки',
	'Dismiss' => 'Скрыть',
	...
	'Welcome to no404' => 'Добро пожаловать в no404',
	'When a visitor lands on a page that no longer exists, no404 finds the closest live page on your site and sends them there with a real server-side 301. There are no redirect rules to write.' => 'Когда посетитель попадает на страницу, которой больше нет, no404 находит самую похожую рабочую страницу вашего сайта и отправляет его туда настоящим серверным 301-перенаправлением. Писать правила перенаправления не нужно.',
	'no404 is a hosted service, so the plugin needs a free no404 account and an API key. Setup takes about two minutes.' => 'no404 — облачный сервис, поэтому плагину нужны бесплатная учётная запись no404 и API-ключ. Настройка занимает около двух минут.',
	'Create a free account' => 'Создать бесплатную учётную запись',
	'I already have an account' => 'У меня уже есть учётная запись',
	'The sign-up page opens in a new tab with this site\'s address filled in. Add the site there, then come back to this tab.' => 'Страница регистрации откроется в новой вкладке с уже заполненным адресом этого сайта. Добавьте там сайт и вернитесь на эту вкладку.',
	'Connect your site' => 'Подключите сайт',
	'In your no404 dashboard, open this site and go to the Integration tab. Copy the API key from the WordPress card and paste it below.' => 'В панели no404 откройте этот сайт и перейдите на вкладку «Интеграция». Скопируйте API-ключ из карточки WordPress и вставьте его ниже.',
	'Open the no404 dashboard' => 'Открыть панель no404',
	'Back' => 'Назад',
	'How should redirects be sent?' => 'Как отправлять перенаправления?',
	'Follow my no404 dashboard (recommended)' => 'Следовать настройкам панели no404 (рекомендуется)',
	'Confident matches and your own redirects get a permanent 301, uncertain guesses a temporary 302. You can change the threshold later in your no404 dashboard without touching WordPress.' => 'Надёжные совпадения и ваши собственные перенаправления получают постоянный 301, неуверенные догадки — временный 302. Порог можно позже изменить в панели no404, не трогая WordPress.',
	'Only if your catalogue is complete: browsers cache a 301 permanently, so a wrong match cannot be taken back.' => 'Только если ваш каталог полон: браузеры кешируют 301 навсегда, и ошибочное совпадение уже не отменить.',
	'Continue' => 'Продолжить',
	'You are all set' => 'Всё готово',
	'no404 is now redirecting pages that are not found on %s.' => 'no404 теперь перенаправляет ненайденные страницы на %s.',
	'Try it with an old address' => 'Проверьте на старом адресе',
	'Enter an address that no longer exists on your site. The test counts as one lookup and shows up in your no404 dashboard.' => 'Введите адрес, которого больше нет на вашем сайте. Проверка засчитывается как один запрос и появится в вашей панели no404.',
	'Go to settings' => 'Перейти к настройкам',
	'Monitoring for this site is paused in the no404 dashboard. Resume it there to start redirecting.' => 'Мониторинг этого сайта приостановлен в панели no404. Возобновите его там, чтобы начать перенаправлять.',
	'Your no404 subscription is not active, so nothing is redirected yet. Check your plan in the no404 dashboard.' => 'Ваша подписка no404 неактивна, поэтому пока ничего не перенаправляется. Проверьте тариф в панели no404.',
	'Your monthly lookup quota is used up. Redirects start again when it resets, or you can upgrade your plan in the no404 dashboard.' => 'Месячная квота запросов исчерпана. Перенаправления возобновятся после её обновления, или вы можете перейти на тариф выше в панели no404.',
	'Your no404 account is suspended. Contact no404 support.' => 'Ваша учётная запись no404 заблокирована. Обратитесь в поддержку no404.',
);
